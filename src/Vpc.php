...
class Vpc extends Rpc
{
    ...
    public function getNatGatewayConvertStatusWithOptions($request, $runtime)
    {
        ...
        return GetNatGatewayConvertStatusResponse::fromMap($this->doRequest('GetNatGatewayConvertStatus', 'HTTPS', 'POST', '2016-04-28', 'AK', null, $request, $runtime));
    }
    ...
    public function updateNatGatewayNatTypeWithOptions($request, $runtime)
    {
        ...
        return UpdateNatGatewayNatTypeResponse::fromMap($this->doRequest('UpdateNatGatewayNatType', 'HTTPS', 'POST', '2016-04-28', 'AK', null, $request, $runtime));
    }
    ...
    public function listEnhanhcedNatGatewayAvailableZonesWithOptions($request, $runtime)
    {
        ...
        return ListEnhanhcedNatGatewayAvailableZonesResponse::fromMap($this->doRequest('ListEnhanhcedNatGatewayAvailableZones', 'HTTPS', 'POST', '2016-04-28', 'AK', null, $request, $runtime));
    }
